...
user_router.post("/register", async (req, res) => {
  // need user email and user password
...
user_router.post("/:id/addFood", async (req, res) => {
  // need all information of a food
  const food_info = {
    name: req.body.name,
...
user_router.post("/:id/deleteFood", async (req, res) => {
  // need the food_id that will be deleted
...
user_router.get(`/:id`, async (req, res) => {
  ...
  res.send({
    ...
    fridge: [high, medium, low]
  });
});

user_router.post("/login", async (req, res) => {
  // need the user email and user password
  await db.connectDB();
